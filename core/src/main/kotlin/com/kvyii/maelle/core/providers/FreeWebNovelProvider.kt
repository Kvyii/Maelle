...
class FreewebnovelProvider(client: HttpClient) : LibReadProvider(client) {
...
/*
class FreewebnovelProvider(client: HttpClient) : MainAPI(client) {
    override val name = "FreeWebNovel"
    override val mainUrl = "https://freewebnovel.com"
    override val hasMainPage = true
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        val chaptersDataphp = client.post(
