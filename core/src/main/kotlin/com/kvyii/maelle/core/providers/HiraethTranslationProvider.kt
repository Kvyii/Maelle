...
import com.kvyii.maelle.core.*
import org.jsoup.Jsoup

open class HiraethTranslationProvider(client: HttpClient) : MainAPI(client) {
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        val document = client.get("$mainUrl/?s=$query&post_type=wp-manga&m_orderby=latest").document
...
//        val chaptersDataphp = client.post("$mainUrl/api/chapterlist.php", data = mapOf("aid" to aid!!))
